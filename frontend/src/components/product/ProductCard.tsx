            ...
            <div className="p-4 md:p-5 space-y-2.5 flex-1 flex flex-col justify-between bg-gradient-to-t from-surface-card to-surface-card/80 relative">
                ...
                <div className="space-y-2">
                    ...
                    <Link href={`/products/${id}`}>
                        <h3 className="text-base md:text-lg font-bold text-ivory/90 group-hover:text-gold-300 transition-colors duration-300 line-clamp-1 font-amiri tracking-wide leading-tight">
                            {name}
                        </h3>
                    </Link>
                </div>
