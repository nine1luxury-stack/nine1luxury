...
const EGYPT_CITIES = [
    ...
    { name: "كفر الشيخ", shipping: 90 },
    { name: "الشرقية", shipping: 90 },
    { name: "الفيوم", shipping: 90 },
    { name: "بنى سويف", shipping: 90 },
    { name: "المنيا", shipping: 90 },
    { name: "اسيوط", shipping: 90 },
    { name: "سوهاج", shipping: 90 },
    { name: "قنا", shipping: 90 },
    { name: "الاقصر", shipping: 90 },
    { name: "اسوان", shipping: 90 },
    { name: "مرسى مطروح", shipping: 120 },
    { name: "شمال سيناء", shipping: 120 },
    { name: "جنوب سيناء", shipping: 120 },
    { name: "البحر الأحمر", shipping: 120 },
    { name: "الوادي الجديد", shipping: 120 },
];
...
export default function BookingPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                setIsSuccess(true);
                setFormData({ name: "", phone: "", city: "", shippingAmount: 0, productModel: "", productSize: "", notes: "" });
                setErrors({});
            } else {
