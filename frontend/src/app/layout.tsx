...
export const metadata: Metadata = {
  title: {
    default: "Nine1Luxury | ملابس شبابية فاخرة — جودة استثنائية وشحن مجاني",
    template: "%s | Nine1Luxury",
  },
  description:
    "Nine1Luxury — وجهتك الأولى للملابس الشبابية الفاخرة في مصر. خامات مستوردة عالية الجودة، شحن مجاني لجميع محافظات مصر بمناسبة الافتتاح، وضمان استبدال على جميع المنتجات. تسوق الآن واكتشف الفرق.",
  keywords: [
    // Brand
    "nine1luxury",
    "Nine 1 Luxury",
