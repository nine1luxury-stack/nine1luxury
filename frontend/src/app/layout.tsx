...
export const metadata: Metadata = {
  title: {
    default: "Nine1Luxury | ملابس شبابية فاخرة — جودة استثنائية وأسعار حصرية",
    template: "%s | Nine1Luxury",
  },
  description:
    "Nine1Luxury — وجهتك الأولى للملابس الشبابية الفاخرة في مصر. خامات مستوردة عالية الجودة، أسعار حصرية لا تُقارن، وضمان استبدال على جميع المنتجات. تسوق الآن واكتشف الفرق.",
  keywords: [
    // Brand
    "nine1luxury",
    "Nine 1 Luxury",
