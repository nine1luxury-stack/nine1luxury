                ...
                >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                        ...
                        <div className="space-y-8">
                            <div>
                                <h2 className="text-xl font-amiri font-bold text-champagne mb-7">معلومات الاتصال</h2>
                            ...
                            {/* Social Media */}
                            <div>
                                <h2 className="text-xl font-amiri font-bold text-champagne mb-5">تابعنا</h2>
                        ...
                        >
                            <h2 className="text-xl font-amiri font-bold text-champagne mb-6">أرسل رسالة</h2>
