...
export default function AdminProductsClient({ initialProducts, initialCategories }: { initialProducts: Product[], initialCategories: any[] }) {
    ...
    // CRUD Replacements avoiding Context Race Conditions
    ...
    const addCategory = async (name: string) => {
        try {
            const added = await categoriesApi.create(name);
            setDbCategories(prev => [...prev, added]);
                                            ...
                                            <td className="px-6 py-5">
                                                ...
                                                >
                                                    <span className={cn(
                                                        ...
                                                        product.isActive !== false ? "ring-green-500/10 bg-green-500" : "ring-red-500/10 bg-red-500"
                                                    )}></span>
                                                    <span className={cn(
