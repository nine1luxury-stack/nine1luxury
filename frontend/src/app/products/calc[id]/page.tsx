        ...
        return (
            <main className="min-h-screen bg-rich-black">
                ...
                <div className="flex flex-col items-center justify-center min-h-screen text-center space-y-8">
                    <h2 className="text-4xl font-amiri font-bold text-ivory">المنتج غائب عن المجموعة</h2>
                    ...
                    <div className="lg:col-span-5 flex flex-col space-y-10">
                        ...
                        <div className="space-y-6">
                            <div className="flex flex-col gap-3">
                                ...
                                <h1 className="text-4xl md:text-6xl font-amiri font-bold text-ivory leading-tight">
                                    {product.name}
                                </h1>
                            </div>

                            <div className="flex items-baseline gap-4">
                                <span className="text-3xl font-amiri font-bold text-champagne">
