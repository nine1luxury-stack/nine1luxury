...
export function ProductsClient({ initialProducts, initialCategories }: ProductsClientProps) {
    ...
    // Using initialData directly avoids global state for this page, improving performance
    const [products] = useState(initialProducts);
    
    // Fallback categories logic
        ...
        <main className="min-h-screen bg-rich-black">
            ...
            <div className="pt-32 pb-24 container mx-auto px-4">
                <div className="flex flex-col items-center justify-center text-center mb-12 space-y-3">
                    <h1 className="text-4xl md:text-5xl font-bold text-white uppercase">المتجر الكامل</h1>
                    <p className="text-gold-300/60 uppercase font-medium">تصفح مجموعتنا الحصرية من الملابس الفاخرة</p>
                </div>
