  ...
  return (
    <main className="min-h-screen bg-rich-black relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center justify-center text-center mb-14 gap-6">
            <div className="flex flex-col items-center">
              ...
              <p className="section-subtitle mt-3 text-center mx-auto animate-fade-in-up" style={{ animationDelay: '200ms' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {offers.length > 0 ? (
              offers.map((offer, idx) => (
                <div
                  key={offer.id}
                  className="group relative h-64 rounded-[2.5rem] overflow-hidden glass-card-premium luxury-shadow-lg border-ivory/[0.05] hover:border-gold-500/30 transition-all duration-700 animate-fade-in-up"
                  style={{ animationDelay: `${idx * 150}ms` }}
                  onMouseMove={(e) => {
      ...
      <section className="pt-16 pb-28 bg-transparent relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center mb-16 text-center">
            ...
            <p className="section-subtitle mb-6 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
              اختيارات منتقاة بعناية تعكس ذوقك الرفيع
            </p>
            <div className="h-px w-24 bg-gradient-to-r from-transparent via-gold-500/40 to-transparent mb-8 animate-fade-in-up" style={{ animationDelay: '300ms' }} />
          ...
          {loading ? (
            ...
            <div
              className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 lg:gap-5 animate-fade-in-up"
            >
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6 max-w-7xl mx-auto">
            {whyUs.map((item, idx) => (
              <div
                key={idx}
                className="glass-card-premium rounded-2xl p-6 md:p-8 text-center space-y-4 group animate-fade-in-up"
                style={{ animationDelay: `${idx * 150}ms` }}
              >
                {/* 3D Icon Container */}
      ...
      <section className="py-28 md:py-36 relative overflow-hidden">
        ...
        {/* Decorative lines */}
        <div
          className="absolute top-1/4 left-0 w-full h-px opacity-30"
